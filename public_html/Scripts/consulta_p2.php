<?php
    ...
    if (!$con) {
        ...
        if(!$con){
            ...
            $cod = $_POST['cod'];
            $req = mysqli_query($con, "SELECT * FROM Pergunta inner join (Resposta, Tema) where Pergunta.cod = Resposta.pergunta and Pergunta.tema = Tema.cod and Pergunta.cod = $cod");
            if (!$req) {
